...
export class News extends Component {
  ...
  async updateNews() {
    ...
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=65e66d586e634433884b122cf12ee15f&page=${this.state.page}&pageSize=${this.props.pageSize}`;
